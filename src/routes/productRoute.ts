...
import { addProduct, deleteProduct, getProducts, getProduct,updateProduct, getCategoryProducts, getProductCount } from '../controllers/productController';
...
router.get('/api/product/count', getProductCount)
